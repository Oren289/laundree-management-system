              ...
              <div class="col-12">
                <div class="card recent-sales overflow-auto">
                  <div class="card-body">
                          ...
                          foreach($query3 as $row){
                            if($row['status'] == 'admin'){ ?>
                              <tr>
                                ...
                                <td>
                                  <a class="btn btn-danger aksiBtn" href="<?php echo "pages-admin-admin.php?username=".$row['username']; ?>">Hapus</a>
                                </td>
                              </tr>
                          <?php $number++; }
                        } ?>
                    ...
                    <div class="text-end">
                      <a href="pages-admin-add-admin.php" class="btn btn-primary">Add Data</a>
                    </div>
                  </div>
                </div>
              </div>

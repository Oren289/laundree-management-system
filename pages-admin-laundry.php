...
<html lang="en">
  <head>
    ...
    <title>Laundree | Laundry Data</title>
  ...
  <body>
    <?php
      ...
      if(!empty($_GET['id_transaksi'])){
        ...
        $stmt = mysqli_prepare($conn, "delete from data_laundry where id_transaksi=?");
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Laundry Data</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
              ...
              <div class="col-12">
                <div class="card recent-sales overflow-auto">
                  <div class="card-body">
                    ...
                    <table class="table table-borderless datatable">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <span id="proses_cucian" class="badge bg-success"><?php echo $row['proses_cucian'] ?></span>
                          </td>
                          <td>
                            <span id="status_pengembalian" class="badge bg-success"><?php echo $row['status_pengembalian'] ?></span>
                          </td>
                          <td>
                            <a class="btn btn-success aksiBtn" href="<?php echo "pages-admin-laundry-edit.php?id_transaksi=".$row['id_transaksi']; ?>">Edit</a>
                            <a class="btn btn-danger aksiBtn" href="<?php echo "pages-admin-laundry.php?id_transaksi=".$row['id_transaksi']; ?>">Hapus</a>
                          </td>
                        </tr>
                        <?php $number++; }
                        ?>
                    ...
                    <div class="text-end">
                      <a href="pages-admin-add.php" class="btn btn-primary">Add Data</a>
                    </div>
                  </div>
                </div>
              </div>

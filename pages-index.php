...
<html lang="en">
  <head>
    ...
    <title>Laundree | Dashboard</title>
            ...
            <div class="row">
                        ...
                        <h6>
                          <span>
                            <?php
                              $total_berat = 0;
                              foreach($query as $row){
                                $total_berat = $total_berat + $row['berat_total'];
                              }
                              echo $total_berat;
                            ?>
                          </span> Kg
              ...
              <div class="col-xxl-4 col-xl-12">
                <div class="card info-card customers-card">
                  <div class="card-body">
                    <h5 class="card-title">Total Clothes</h5>
                      ...
                      <div class="ps-3">
                        <h6>
                          <?php
                            $total_pakaian = 0;
                            foreach($query as $row){
                              $total_pakaian = $total_pakaian + $row['jumlah_cucian'];
                            }
                            echo $total_pakaian;
                          ?>
                        </h6>

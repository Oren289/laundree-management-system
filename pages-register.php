  ...
  <body>
    ...
    <?php
      ...
      if(!empty($_POST['username'])){
        ...
        $stmt = mysqli_prepare($conn, "insert into data_user (username, email, password, status) values (?, ?, ?, ?)");
        mysqli_stmt_bind_param($stmt, 'ssss', $username, $email, $password, $status);
